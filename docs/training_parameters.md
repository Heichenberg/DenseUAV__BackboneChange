...
- `--backbone_weight`: Path to third-party backbone pretrained weights. This is only for initializing the backbone and is different from `--load_from`, which restores a full DenseUAV checkpoint.
